# ByteDrop - P2P File Sharing Application

ByteDrop is a peer-to-peer file sharing application that allows users to share files directly between devices using a simple invite code system.
...
- `ui/`: ReactJs frontend application
  - `src/app`: ReactJs app router pages
...
┌─────────────┐      ┌─────────────┐      ┌─────────────┐
│             │      │             │      │             │
│  ReactJS UI │◄────►│ Java Server │◄────►│ Peer Device │
│             │      │             │      │             │
└─────────────┘      └─────────────┘      └─────────────┘
```
...
classDiagram
    ...
    %% Relationships
    ReactJSApp --> FileUploadComponent
    ReactJSApp --> FileDownloadComponent
    ...
    %% Component Notes
    note for ReactJSApp "Handles UI state and user interactions"
...
1. **Frontend Components**
   - `ReactJSApp`: Main application component managing state and routing
